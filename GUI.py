...
pc = PhotoImage(file="/home/john/Rob2_3202/bgrobo.png")  #Make sure to change the address to where the bgrobo is located in your files after downloading the photo.
#Also check the filename if it's correct.
